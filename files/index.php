...
<div class="navbar navbar-inverse navbar-fixed-top " id="menu">
    <div class="container">
        <div align="center">
            <h3 align="center">TIME TABLE MANAGEMENT SYSTEM, INFORMATION TECHNOLOGY DEPARTMENT</h3>
        </div>
    </div>
</div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        <div class="item active">
            <img src="assets/img/it1.png" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/it2.jpg" alt="Chania">
        </div>

        <div class="item">
            <img src="assets/img/it3.jpg" alt="Flower">
        </div>

        <div class="item">
            <img src="assets/img/it4.jpg" alt="Flower">
        </div>
    </div>
</div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.4s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/VS.jpg" class="img-rounded"/>
                    <h3 align="center">Prof. Vinaya Sawant</h3>
                    <hr/>
                    <h4 align="center">HOD<br/>Information Technology</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.5s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/HV.jpg" class="img-rounded"/>
                    <h3 align="center">Dr. Hari Vasudevan</h3>
                    <hr/>
                    <h4 align="center">Principal<br/> DJSCE</h4>

                </div>
            </div>
            <div class="col-lg-4  col-md-4 col-sm-4" data-scroll-reveal="enter from the bottom after 0.6s">
                <div class="faculty-div">
                    <img src="assets/img/faculty/President.png" class="img-rounded"/>
                    <h3 align="center">Amrish R. Patel</h3>
                    <hr/>
                    <h4 align="center">President<br/>DJSCE</h4>
