...
<form action="generatetimetable.php" method="post">
    <div align="center" style="margin-top: 20px">
        <select name="select_semester" class="list-group-item">
            ...
            <option value="3">3/I1</option>
            <!--<option value="4">4</option>-->
            <option value="5">5/I1</option>
            <!--<option value="6">6</option>-->
            <option value="7">5/I2</option>
        ...
        <table border="2" cellspacing="3" align="center" id="timetable">
            <caption><strong><br><br>
                    ...
                    if (isset($_POST['select_semester'])) {
                        //echo "INFORMATION DEPARTMENT SEMESTER " . $_POST['select_semester'] . " ";
                        echo "INFORMATION TECHNOLOGY DEPARTMENT "; 
                ...
                <td style=\"text-align:center\">LUNCH</td>
                 <td style=\"text-align:center\">{$row['period4']}</td>
                  ...
                  <td style=\"text-align:center\">{$row['period6']}</td>
                    ...
                    echo '</table>';
                    $sign = "GENERATED VIA TIMETABLE MANAGEMENT SYSTEM, INFORMATION TECHNOLOGY.";
